...
const reasons: Reason[] = [
  ...
  { title: "for your sacrifices",
    letter: "We will never know all of them. That's the point of a sacrifice — it goes uncounted on purpose. But we see the shape of them in the life we got to have, and we will spend the rest of ours being grateful for the considerations you made in silence." },
  { title: "for your strength",
    letter: "You carry weight like it doesn't weigh anything. Eleven years in one chapter and then the courage to open a new one — that's not stubbornness, that's spine. We're learning from it." },
  ...
  { title: "for your patience",
    letter: "For the strength and the resilience throughout these years, without losing hope. That patience is the floor we walk on. Papa,you are truly our hero<3 " },
  ...
  { title: "for always pushing us forward",
    letter: "Career or otherwise — you believed in our heads before we did. You bet on us when we were still figuring out what the bet was. Whatever we become, the first hand on the wheel was yours." },
];
